...
| 4 | Some context for the denial has been provided. At a minimum the context includes the condition / medical situation being treated, the service / treatment being used, and at least some description of the specific events or rationale leading to the coverage request. It would be moderately difficult to extend the description in any realistic way that would alter the sufficiency determination. | "An enrollee requested a power seat elevator for her power wheelchair for treatment of the enrollee, who has a history of a spinal cord injury. With power seat elevation, the patient would be able to adjust the seat of her wheelchair to be level with the transfer surface, to perform a level surface transfer independently with a sliding board." |
| 5 | A (relatively) complete context for the denial has been provided. At a minimum the context includes the condition / medical situation being treated, the service / treatment being used, and at least some description of the specific events or rationale leading to the coverage request. It would be extremely difficult to extend the description in any realistic way that would alter the sufficiency determination. | “This patient has extensive and inoperable carcinoma of the stomach. He was started on chemotherapy with Xeloda and Oxaliplatin, because he has less nausea with Oxaliplatin than with the alternative, Cisplatin. Oxaliplatin was denied as experimental for treatment of his gastric cancer.” |
