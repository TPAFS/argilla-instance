...
The goal here is to nonetheless assign *relative* sufficiency scores from 1-5, that adhere to a consistent relative annotation standard for any given annotator. Any differences that might arise in the relative scales used by different annotators will be evaluated and controlled for after the fact.
